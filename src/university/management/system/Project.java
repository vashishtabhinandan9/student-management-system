...
public class Project extends JFrame implements ActionListener{
    Project(){
        ...
        JMenuBar mb  = new JMenuBar();//this is for a menubar
        {
            JMenu master = new JMenu("Master");//this is what apears on menubar(file,edit,etc)
            JMenuItem m1 = new JMenuItem("New Faculty");//this is what apears when you hover onmenubar things
            //(new,open,openrecent,etc when you go on file)
            JMenuItem m2 = new JMenuItem("New Student Admission");
            master.setForeground(Color.BLUE);//this is set color of the master's text
            ...
            m1.setIcon(new ImageIcon(image1));//this adds image along with the m1text
            m1.setMnemonic('A');//this adds the memonic here a is set to be memonis
            ...
            master.add(m1);//adds menuitems to menuthings
            master.add(m2);



            mb.add(master);//adds menuthings to menubar
            m1.addActionListener(this);
            m2.addActionListener(this);


        }//add teacehr,student,etc
        ...
        setJMenuBar(mb);//adds menubar to frame
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        /*
        this is to open the web browser
